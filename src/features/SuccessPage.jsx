        ...
        <Container>
            <div className="flex flex-col items-center text-center relative">
                ...
                <p className="mt-3 text-sm text-sky-600">
                    We'll send a confirmation email to <span className="font-medium">consult@vopromos.com .Our team will reach out soon to discuss your sourcing and logistics needs.</span>
                </p>
